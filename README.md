...
## Overview
The SMS Spam Detection is a machine learning model that takes an SMS as input and predicts whether the message is a spam or not spam message. The model is built using Python and deployed on the web using Streamlit.
...
## Demo
To try out the SMS Spam Detection model, visit [here](https://sms-spam-detecting-tool.streamlit.app/).

## Usage
This is a project made as a model for internship submission.
